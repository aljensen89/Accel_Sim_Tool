noisy_true_model_cs_sim <- function(beta_vector,cs_rho){
  ## Grabbing file names
  sim_files <- list.files(path="/Users/ajensen/Library/CloudStorage/Box-Box/Desai_R01_Work Folder/Clustering Manuscript/simulated_data/1ee63015eba36f0e4aa00549233089f3_raw_cohort/",
